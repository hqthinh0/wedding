...
// import imgStore from '../../assets/img/heart.png';
        ...
        <section className='story'>
            <div className='story__container wrp-container'>
                <div className='story__flex grid-row'>
					<div className='grid-col--4 story__order--bride story__heart'>
					...
					<div className='grid-col--4 story__order--groom'>
						<div className='story__bride-groom'>
					...
					<div className='story__gallery grid-col--4'>
						<Gallery/>
					</div>
